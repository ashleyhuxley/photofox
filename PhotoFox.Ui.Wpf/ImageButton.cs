...
namespace PhotoFox.Ui.Wpf
{
    public class ImageButton : Button
    {
        ...
        public ImageButton()
        {
            this.SetCurrentValue(ImageButton.ImageLocationProperty, Wpf.ImageLocation.Left);
        }
